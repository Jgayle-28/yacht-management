...
const ExpandButton = ({ buttonText = '', onClick = () => {} }) => {
  return (
    <button
      onClick={onClick}
      className='group flex h-10 items-center gap-2 pl-3 pr-4 transition-all duration-300 ease-in-out hover:bg-brandPrimary hover:pl-2 text-brandPrimary hover:text-white active:bg-neutral-700 border-brandPrimary/50 border border-transparent'
    >
